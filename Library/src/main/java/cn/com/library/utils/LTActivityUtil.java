...
public class LTActivityUtil {
    ...
    private static LTActivityUtil instance;
    private long clickTime = 0; //记录第一次点击的时间

    private LTActivityUtil() {
     ...
     * @return
     */
    public static LTActivityUtil getInstance() {
        if (null == instance) {
            instance = new LTActivityUtil();
        }
        return instance;
    }
