...
import java.io.File;
import letuizu.com.moduleim.db.DaoMaster;
...
public class DBManager {
    ...
    private DBManager(Context context) {
        DaoMaster.OpenHelper helper = new DaoMaster.DevOpenHelper(new RongDatabaseContext(context, getDbPath()), DB_NAME, null);
