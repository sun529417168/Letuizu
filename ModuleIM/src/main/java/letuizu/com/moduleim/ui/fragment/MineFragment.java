...
import letuizu.com.moduleim.ui.activity.AboutRongCloudActivity;
import letuizu.com.moduleim.ui.activity.AccountSettingActivity;
import letuizu.com.moduleim.ui.activity.MyAccountActivity;
...
public class MineFragment extends Fragment implements View.OnClickListener {
    ...
    private void updateUserInfo() {
        ...
        if (!TextUtils.isEmpty(userId)) {
            ...
            ImageLoader.getInstance().displayImage(portraitUri, imageView);
        }
    }
