package letuizu.com.moduleim.ui.adapter;
...
import letuizu.com.moduleim.ui.activity.SealSearchMoreGroupActivity;
...
public class GroupListAdapter extends android.widget.BaseAdapter {
    ...
    public GroupListAdapter(SealSearchMoreGroupActivity context, List<String> filterGroupId, Map<String, List<GroupMember>> filterGroupNameListMap, Map<String, List<GroupMember>> filterGroupMemberNameListMap, String mFilterString) {
    }
