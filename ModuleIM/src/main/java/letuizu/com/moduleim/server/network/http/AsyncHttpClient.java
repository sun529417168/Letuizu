...
package letuizu.com.moduleim.server.network.http;

import android.content.Context;
import android.util.Log;


import com.alivc.player.model.HttpClient;
...
public class AsyncHttpClient {
     ...
     */
    private static class InflatingEntity extends HttpEntityWrapper implements HttpEntity {
